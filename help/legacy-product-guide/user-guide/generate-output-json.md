...
| Indexfil | Du kan ge indexfilen ett namn som du skapar för JSON-utdata. Som standard väljs DITA-mappningens filnamn och ett suffix läggs till (som `map_filename_index.json`).<br><br>Du kan också använda variabler när du anger indexfilen. Mer information om hur du använder variabler finns i [Använd variabler för att ange alternativen Målsökväg, Platsnamn eller Filnamn](generate-output-use-variables.md#id18BUG70K05Z). |
