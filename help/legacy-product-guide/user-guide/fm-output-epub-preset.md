...
>[!NOTE]
>
> Om du vill öppna förinställningar för EPUB klickar du på FrameMakerna \(`.fm` eller `.book`\), sedan på Utdatainställningar och sedan på alternativet EPUB.
...
| Inställningsnamn | Ge EPUBEN ett beskrivande namn för de utdatainställningar du skapar. Du kan till exempel ange *interna kunders utdata* eller *slutanvändares utdata*. |
