...
| --- | --- |
| Publish-profil | Använd listrutan för att välja bland de anslutningsprofiler för Salesforce som administratören konfigurerar. Mer information om hur administratören kan skapa en publiceringsprofil finns i funktionsbeskrivningen för **redigeringsinställningar** i avsnittet [Vänster panel](./web-editor-features.md#id2051EA0M0HS). |
