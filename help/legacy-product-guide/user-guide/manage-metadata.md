...
Metadata är beskrivningen eller definitionen av ditt innehåll. Metadata är användbara när du vill definiera en artikel eller karta. PDF-metadata kan t.ex. bestå av egenskaperna för ett dokument, t.ex. en titel, författare, ämne, nyckelord och språk. AEM Guides har olika verktyg som du kan använda för att definiera metadata för ditt innehåll.
