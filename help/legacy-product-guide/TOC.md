---
user-guide-title: Experience Manager Guides (äldre)
...
- [Förstå äldre](legacy.md)
- [Versionsinformation (primär guide)](https://experienceleague.adobe.com/en/docs/experience-manager-guides/using/release-info/aem-guides-releases-roadmap){target="_blank"}
