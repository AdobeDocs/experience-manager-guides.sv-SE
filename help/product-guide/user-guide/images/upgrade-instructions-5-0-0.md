...
En lista över problem som har åtgärdats i den här versionen finns i [Åtgärdade problem i version 5.0.0](/help/product-guide/release-info/fixed-issues-5-0-0.md).
...
Mer information finns i [Uppgraderingsinstruktioner för de lokala versionerna](/help/product-guide/install-guide/upgrade-xml-documentation.md) av Experience Manager Guides.
