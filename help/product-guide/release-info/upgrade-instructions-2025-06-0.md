---
title: Versionsinformation | Uppgraderingsinstruktioner och åtgärdade fel i Adobe Experience Manager Guides, version 2025.06.0
description: Läs om kompatibilitetsmatrisen och hur du uppgraderar till version 2025.06.0 av Adobe Experience Manager Guides as a Cloud Service.
...
# Uppgraderingsinstruktioner för 2025.06.0

Den här artikeln handlar om uppgraderingsinstruktioner och kompatibilitetsmatrisen för version 2025.06.0 av Adobe Experience Manager Guides as a Cloud Service.
...
I det här avsnittet beskrivs kompatibilitetsmatrisen för de program som stöds i version 2025.06.0 av Experience Manager Guides as a Cloud Service.

### FrameMaker och FrameMaker Publishing Server

| Experience Manager Guides som Cloud-release | FMPS | FrameMaker |
| --- | --- | --- |
| 2025.06.0 | Inte kompatibel | 2022 eller senare |
...
| --- | --- | --- | --- | --- |
| 2025.06.0 | 3.8 -uuuid 1 | 3.8 -uuuid 1 | 2,3 | 2,3 |
...
## Uppgradera till version 2025.06.0
