---
title: Versionsinformation | Uppgraderingsinstruktioner och åtgärdade fel i Adobe Experience Manager Guides, version 2026.04.0
description: Läs om kompatibilitetsmatrisen och hur du uppgraderar till version 2026.04.0 av Adobe Experience Manager Guides as a Cloud Service.
...
# Uppgraderingsinstruktioner för version 2026.04.0

Den här artikeln beskriver uppgraderingsinstruktioner och kompatibilitetsmatrisen för version 2026.04.0 av Adobe Experience Manager Guides as a Cloud Service.

Mer information om de nya funktionerna och förbättringarna finns i [Nyheter i version 2026.04.0](whats-new-2026-04-0.md).
...
I det här avsnittet beskrivs kompatibilitetsmatrisen för de program som stöds i version 2026.04.0 av Experience Manager Guides as a Cloud Service.

### FrameMaker och FrameMaker Publishing Server

| Experience Manager Guides som Cloud-release | FMPS | FrameMaker | Syrgasförfattare |
| --- | --- | --- | --- |
| 2026.04.0 | Inte kompatibel | 2022 eller senare | 26,1 |
...
| --- | --- | --- | --- | --- |
| 2026.04.0 | 3.8 -uuuid 1 | 3.8 -uuuid 1 | 2,3 | 2,3 |
...
## Uppgradera till version 2026.04.0
