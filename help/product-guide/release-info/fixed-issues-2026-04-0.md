---
title: Versionsinformation | Åtgärdade problem i Adobe Experience Manager Guides, version 2026.04.0
description: Läs mer om felkorrigeringarna i version 2026.04.0 av Adobe Experience Manager Guides as a Cloud Service.
...
# Åtgärdade problem i version 2026.04.0

Den här artikeln handlar om buggar som har åtgärdats i olika delar av version 2026.04.0 av Adobe Experience Manager Guides as a Cloud Service.

Mer information om de nya funktionerna och förbättringarna finns i [Nyheter i version 2026.04.0](whats-new-2026-04-0.md).

Läs mer om [uppgraderingsinstruktioner för version 2026.04.0](upgrade-instructions-2026-04-0.md).
...
Adobe har identifierat följande kända fel i version 2026.04.0:
