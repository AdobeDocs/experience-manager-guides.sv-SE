...
# Uppgraderingsinstruktioner för version 2024.2.0

Den här artikeln handlar om uppgraderingsinstruktioner och kompatibilitetsmatrisen för version 2024.2.0 av Adobe Experience Manager Guides as a Cloud Service.
...
I det här avsnittet visas kompatibilitetsmatrisen för de program som stöds i version 2024.2.0 av Experience Manager Guides as a Cloud Service.

### FrameMaker och FrameMaker Publishing Server

| Experience Manager Guides as a Cloud Release | FMPS | FrameMaker |
| --- | --- | --- |
| 2024.2.0 | Inte kompatibel | 2022 eller senare |
| | | |
...
## Uppgradera till version 2024.2.0
...
Utför följande steg för as a Cloud Service stödlinjer i Experience Manager om du inte har gjort det tidigare för den befintliga versionen:
