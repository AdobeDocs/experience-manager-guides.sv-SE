...
1. Uppdatera `<dox.version>` egenskap i `/dox/dox.installer/pom.xml` fil med dina Cloud Service Git-kod till 2023.3.242.
1. Genomför ändringarna och kör Cloud Servicen i pipeline för att uppgradera till mars 2023-utgåvan av AEM Guides as a Cloud Service.
