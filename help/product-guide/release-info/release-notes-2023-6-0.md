...
2. Uppdatera egenskapen `<dox.version>` i `/dox/dox.installer/pom.xml`-filen för Git-koden för molntjänster till 2023.6.297.
3. Genomför ändringarna och kör Cloud Services-pipeline för att uppgradera till versionen från juni 2023 av AEM Guides as a Cloud Service.
...
I det här avsnittet listas kompatibilitetsmatrisen för de program som stöds av AEM Guides as a Cloud Service från juni 2023.
...
- Web Editor | Det går inte att välja utdatasökväg och -mall i AEM-förinställningen. (11530)
...
- PDF | Språkmetadata kan inte anges i den genererade PDF så att de överensstämmer med WCAG 2.0. (12296)
