...
# Nyheter i version 2026.03.0 (mars 2026)

I den här artikeln beskrivs de nya och förbättrade funktionerna som introducerades i version 2026.03.0 av Adobe Experience Manager Guides as a Cloud Service.
...
Läs mer om [uppgraderingsinstruktioner för version 2026.03.0](../release-info/upgrade-instructions-2026-03-0.md).
