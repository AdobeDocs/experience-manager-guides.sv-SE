---
title: Versionsinformation | Uppgraderingsinstruktioner och åtgärdade fel i Adobe Experience Manager Guides, version 2025.02.0
description: Läs om kompatibilitetsmatrisen och hur du uppgraderar till version 2025.02.0 av Adobe Experience Manager Guides as a Cloud Service.
...
# Uppgraderingsinstruktioner för version 2025.02.0

I den här artikeln beskrivs uppgraderingsinstruktionerna och kompatibilitetsmatrisen för version 2025.02.0 av Adobe Experience Manager Guides as a Cloud Service.

Mer information om de nya funktionerna och förbättringarna finns i [Nyheter i version 2025.02.0](whats-new-2025-02-0.md).

En lista över problem som har åtgärdats i den här versionen finns i [Åtgärdade problem i version 2025.02.0](fixed-issues-2025-02-0.md).

## Kompatibilitetsmatris

I det här avsnittet visas kompatibilitetsmatrisen för de program som stöds i version 2025.02.0 av Experience Manager Guides as a Cloud Service.

### FrameMaker och FrameMaker Publishing Server

| Experience Manager Guides som Cloud-release | FMPS | FrameMaker |
| --- | --- | --- |
| 2025.02.0 | Inte kompatibel | 2022 eller senare |
| | | |
...
| --- | --- | --- | --- | --- |
| 2025.02.0 | 3.8 -uuuid 1 | 3.8 -uuuid 1 | 2,3 | 2,3 |
|  |  |  |  |  |
...
## Uppgradera till version 2025.02.0
