...
description: Läs mer om kompatibilitetsmatrisen och hur du uppgraderar till 2024.06.0-utgåvan av Adobe Experience Manager Guides as a Cloud Service.
...
I den här artikeln beskrivs uppgraderingsinstruktionerna och kompatibilitetsmatrisen för 2024.06.0-utgåvan av Adobe Experience Manager Guides as a Cloud Service.
...
I det här avsnittet listas kompatibilitetsmatrisen för de program som stöds i version 2024.06.0 av Experience Manager Guides as a Cloud Service.
...
|---|---|---|
| Innehållspaket för komponenter i Experience Manager-stödlinjer för Cloud Service | dxml-components.all-1.2.2 | aem-site-template-dxml.all-1.0.16 |
...
I föregående svar, JSON, nyckeln `lockNodePath` innehåller sökvägen till den nod som skapas i databasen, som pekar på det skickade jobbet. Den tas automatiskt bort när jobbet är klart. Du kan referera till den här noden för jobbstatus.
