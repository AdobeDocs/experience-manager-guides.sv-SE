...
2. **Konfigurera förinställning för AEM-webbplats:** Det finns två alternativ för att konfigurera OTB-webbplatsen:
   ...
   **Alternativ 2: Använd webbplatssökvägen**
   ...
   1. Ange **platssökvägen** manuellt som `/content/aemg-docs/en/docs/product1`.
...
1. **Generera plats:**
   ...
   2. Den genererade webbplatsen kommer att vara tillgänglig på sökvägen: `/content/aemg-docs/en/docs/product1`.
