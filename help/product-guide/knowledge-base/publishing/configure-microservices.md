...
description: Lär dig hur du konfigurerar ny mikrotjänstbaserad publicering för AEM Guides.
...
Eftersom JWT-autentiseringsuppgifterna (Service Account) har tagits bort rekommenderar vi att du använder OAuth-baserad autentisering med Adobe IMS. Lär dig hur du [konfigurerar mikrotjänstbaserad publicering med OAuth-autentisering](configure-microservices-imt-config.md).
...
1. Välj **API** i listrutan **Lägg till i projekt** om du vill lägga till API för IO-hantering i projektet.
...
1. Gå tillbaka till fliken **Projekt** och klicka på **Projektöversikt** till vänster.
