...
### Konvertera befintliga Word-dokument till ämnesdokument i DITA

Följande flikar innehåller anvisningar om hur du konverterar befintliga Word-dokument till ämnesdokument för DITA baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
1. Överför Word-källdokumenten till den här mappen. Mer information om hur du överför innehåll på DAM finns i [Överför befintligt DITA-innehåll](upload-dita-content.md#).
...
Konverteringsprocessen kräver dessutom [Förbered InDesign-filer för konvertering](aemg-appendix.md#id195DBF0045Z) och [Förbered mappningsfilen för InDesign till DITA-migrering](aemg-appendix.md#id194AF0003HT). Sedan måste du följa den angivna proceduren för att köra konverteringsprocessen.
...
1. Skapa en överläggsnod av mappen `config` i noden `apps`.
   ...
   - I elementet `mapStyle` anger du platsen för mappningsfilen som innehåller mappningar för InDesign-dokumentformat till DITA-element. Standardmappningen sparas i filen som finns på:
     ...
     >[!NOTE]
     >
     > Mer information om strukturen för filen `stmap.adobeidml.xml` och hur du kan anpassa den finns i [Bilaga](aemg-appendix.md#id194AF0003HT).
...
1. Överför InDesign-källdokumenten till den här mappen. Mer information om hur du överför innehåll på DAM finns i [Överför befintligt DITA-innehåll](upload-dita-content.md#).
...
### Konvertera ditt befintliga XHTML-dokument till DITA-avsnitt

Följande flikar innehåller anvisningar om hur du konverterar befintliga XHTML-dokument till DITA-avsnitt baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
1. Överför XHTML-källdokumenten till den här mappen. Mer information om hur du överför innehåll på DAM finns i [Överför befintligt DITA-innehåll](upload-dita-content.md#).
...
Efter konverteringen kan det strukturerade innehållet migreras till AEM Guides. Mer information finns i [Överför befintligt DITA-innehåll med WebDAV-verktyget och FrameMaker](./upload-dita-content.md).
...
Följande flikar innehåller anvisningar om hur du migrerar andra strukturerade dokument baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
1. Överför de källstrukturerade dokumenten till den här mappen. Mer information om hur du överför innehåll på DAM finns i [Överför befintligt DITA-innehåll](upload-dita-content.md#).
