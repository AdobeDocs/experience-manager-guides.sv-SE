...
Så här hämtar och installerar du AEM Guides för första gången:
...
1. Hämta AEM Guides från [Adobe portal för distribution av programvara](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html).

   >[!NOTE]
   >
   >Kontrollera att datorn uppfyller de [tekniska kraven](../install-conf-guide/aemg-technical-requirements.md) innan du installerar Experience Manager Guides.
...
1. Logga in på din AEM-instans och navigera till CRX Package Manager. Standardwebbadressen för att få åtkomst till pakethanteraren är:
   ...
   Pakethanteraren hanterar paketen på din lokala AEM-installation. Mer information om hur du arbetar med pakethanteraren finns i [Arbeta med paket](https://helpx.adobe.com/se/experience-manager/6-5/sites/administering/using/package-manager.html) i AEM-dokumentationen.
