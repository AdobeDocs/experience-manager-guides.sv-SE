...
- Vitlista URL:en för POST-begäran. Nedan ges en exempelregel för `/filters`: Lägg till den här regeln i konfigurationsfilen för dispatcher:

```json
/xxxx {/type "allow" /method "POST" /url "/home/users/*/preferences"}
```

- Kontrollera att URL-mönstret `/libs/cq/security/userinfo.json` inte cachas av författardispatchern, så lägg till en regel `\(like below\)` i `author\_dispatcher.any`
