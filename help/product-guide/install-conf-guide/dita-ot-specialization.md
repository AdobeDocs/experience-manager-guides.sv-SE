...
På följande flikar finns anvisningar om hur du använder anpassade DITA-OT-plugin-program baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
Följande flikar innehåller anvisningar om hur du integrerar DITA-specialisering baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
1. Ange sökvägen för anpassade DTD- och XSD **-filer i AEM-databasen i inställningarna** Schema **\>** Katalog`catalog.xml` .
...
>[!NOTE]
>
> Du kan exportera den anpassade DITA-profilen som ett paket och överföra den till andra AEM Guides-instanser för att spara tid. Mer information finns i [Bilaga](./aemg-appendix.md).
