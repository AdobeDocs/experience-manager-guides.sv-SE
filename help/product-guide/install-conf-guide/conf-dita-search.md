...
På följande flikar finns anvisningar om hur du lägger till anpassade DITA-element eller -attribut i sökserialiseringsfilen baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
Följande flikar innehåller instruktioner om hur du aktiverar metadataextraheringsalternativet i `configMgr` baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

Använd instruktionerna i [Konfigurationsåsidosättningar](download-install-config-override.md#) för att skapa konfigurationsfilen. Ange följande \(egenskap\)-information i konfigurationsfilen för att konfigurera alternativet för metadataextrahering:
...
Följande flikar innehåller anvisningar om hur du exkluderar den tillfälliga översättningsmappen från sökningen baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
