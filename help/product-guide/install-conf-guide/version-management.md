...
Följande flikar innehåller anvisningar om hur du aktiverar alternativet **Skapa ny version för den överförda filen** baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
På följande flikar finns instruktioner om hur du konfigurerar inställningar som tillåter redigering av utcheckade filer baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

Använd instruktionerna i [Konfigurationsåsidosättningar](download-install-config-override.md#) för att skapa konfigurationsfilen. Ange följande \(egenskap\)-information i konfigurationsfilen för att konfigurera redigering av utcheckade filer:
...
På följande flikar finns instruktioner som gör att användare kan skriva över filen vid överföring som har checkats ut av dem eller någon annan användare baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
| PID | Egenskapsnyckel | Egenskapsvärde |
|---|------------|--------------|
| `com.adobe.fmdita.config.ConfigManager` | `overwrite.checkout.onupload` | Boolean \(true/false\).<br> **Standardvärde**: `false` |
...
Följande flikar innehåller anvisningar som förhindrar att användare av misstag tar bort filer som har checkats ut av dem eller någon annan användare baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

Använd instruktionerna i [Konfigurationsåsidosättningar](download-install-config-override.md#) för att skapa konfigurationsfilen. Ange följande \(egenskap\)-information i konfigurationsfilen för att förhindra att användare tar bort filer som har checkats ut av misstag:
...
På följande flikar finns instruktioner för hur du definierar vem som kan ta bort en fil som innehåller referenser eller som refereras av andra filer baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.

>[!BEGINTABS]

>[!TAB Cloud Service]

Använd instruktionerna i [Konfigurationsåsidosättningar](download-install-config-override.md#) för att skapa konfigurationsfilen. Ange följande \(egenskap\)-information i konfigurationsfilen för att definiera vem som kan ta bort en fil som innehåller referenser eller som andra filer refererar till:
