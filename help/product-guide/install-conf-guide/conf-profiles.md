...
- **Konfigurationer för XML-redigeraren**: Använd den här fliken om du vill anpassa utseendet och de olika funktionerna i Web Editor. Följande konfigurerbara inställningar är tillgängliga för Web Editor:
   ...
   - Konfiguration av XML-redigerare endast för Cloud Service
   - CSS-mallayout
...
**Använd anpassat attribut**

Om du använder ett anpassat attribut måste det vara ett giltigt DITA-attribut som stöds av DTD:n. Följande flikar innehåller anvisningar om hur du använder attribut, som inte är ett DITA-standardattribut baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
Följande flikar innehåller anvisningar om hur du konfigurerar redigeringsmallar baserat på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
...
Förutom förinställningarna som konfigurerats på global nivå eller företagsnivå har utgivaren fortfarande behörighet att skapa fler förinställningar. Dessa förinställningar är dock kopplade till den DITA-karta som de skapas för. Mer information om hur du skapar förinställningar för vanliga utdata för en DITA-karta, beroende på vilken inställning du använder, finns i *Skapa, redigera, duplicera eller ta bort en förinställning för utdata* i Använda Adobe Experience Manager Guides.
...
1. Gör något av följande om du vill skapa eller redigera en förinställning för utdata:
   ...
   - Klicka på **Redigera** för att öppna den markerade förinställningens konfiguration för redigering.
     ...
     Mer information om inställningar för förinställningar för utdata, beroende på vilken inställning du använder, finns i *Förstå förinställningarna* i Använda Adobe Experience Manager Guides.
...
## Konfigurera AI Assistant för smart hjälp och redigering (endast för Cloud Service)
...
Följande flikar innehåller information som baseras på din Experience Manager Guides-konfiguration: Cloud Service eller On-Premise.
