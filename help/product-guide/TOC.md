   ...
   - Versionsinformation {#release-notes}
      - Molntjänster {#cloud-release-notes}
         ...
         - 2026 års utgåvor {#2026-releases}
            - 2026.04.0-utgåvan {#2604-release}
               - [Nyheter](./release-info/whats-new-2026-04-0.md)
               - [Åtgärdade problem](./release-info/fixed-issues-2026-04-0.md)
               - [Uppgraderingsinstruktioner](./release-info/upgrade-instructions-2026-04-0.md)
      ...
      - Lokalt/Managed Services {#on-prem-release-notes}
         ...
         - [4.0.x Versionsinformation](https://helpx.adobe.com/se/xml-documentation-for-experience-manager/release-note/release-notes-xml-documentation-solution-4-0.html)
         - [Versionsinformation om 3.8.x](https://helpx.adobe.com/se/xml-documentation-for-experience-manager/release-note/release-notes-xml-documentation-solution-3-8.html)
   ...
   - Hantera utbildningsinnehåll {#learning-training-content}
      - Guiden Komma igång {#get-started}
         - Introduktion {#intro-lc}
            ...
            - [Versionsinformation](./release-info-lt/release-notes-lt-2026-02-v3.md)
...
- Installation och konfiguration {#install-guide}
   - Lokalt {#on-prem-ig}
      ...
      - Arbeta med inställningar för utdatagenerering {#output-gen-config}
         ...
         - [Hämta och installera AEM Sites-mallar](./install-guide/download-install-aem-sites-templates.md)
         - [Komponentmappning för AEM Sites](./install-guide/component-mapping.md)
...
- Installation och konfiguration {#install-conf-guide}
   ...
   - Installationsprocess för lokal installation {#deploy-conf-aemg-on-prem}
      ...
      - [Avinstallera AEM Guides](./install-conf-guide/uninstall-aemg.md)
   ...
   - Innehållsmigrering {#migrate-content-cs}
      ...
      - [Överför befintligt DITA-innehåll med FrameMaker och WebDav-verktyget för lokal användning](./install-conf-guide/upload-dita-content.md)
