...
- Administratörer som installerar och hanterar AEM Guides på Adobe Experience Manager.
...
- [Integrera skrivbordsbaserade XML-redigerare](integrate-desktop-editors.md#): I det här avsnittet beskrivs de inställningar du behöver för att aktivera redigering av dokument i en extern XML-redigerare.
